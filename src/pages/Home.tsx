  ...
  return (
    <div className="min-h-screen flex flex-col dark:bg-gray-900">
      ...
      <section id="techs" className="py-16 bg-muted/50 dark:bg-muted/10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative overflow-hidden py-4">
            <div className="w-max flex tech-marquee">
              <div className="flex gap-6 pr-6">
                {techs.map((tech) => (
                  <div
                    key={`first-${tech.id}`}
                    className="min-w-30 bg-background dark:bg-muted/50 flex flex-col items-center gap-2 border rounded-xl p-4 hover:shadow-sm dark:hover:shadow-gray-700 hover:scale-105 transition duration-500"
                  >
                    <img
                      src={tech.icon}
                      alt={tech.name}
              ...
              <div className="flex gap-6 pr-6">
                {techs.map((tech) => (
                  <div
                    key={`second-${tech.id}`}
                    className="min-w-30 bg-background dark:bg-muted/50 flex flex-col items-center gap-2 border rounded-xl p-4 hover:shadow-sm dark:hover:shadow-gray-700 hover:scale-105 transition duration-300"
                  >
                    <img
                      src={tech.icon}
                      alt={tech.name}
      ...
      <section className="px-4 py-40 text-center">
        ...
        <div className="sm:w-1/2 lg:w-1/3 mx-auto gap-2 flex items-center justify-between text-muted-foreground">
          <a
